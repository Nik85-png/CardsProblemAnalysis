...
async function submitMove(move) {
    const res = await fetch(`${API_BASE}/api/play/session/${state.sessionId}/move`, {
        method: 'POST',
...
async function startSession() {
    ...
    const res = await fetch(`${API_BASE}/api/play/session/start`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function completeSession() {
    ...
    const res = await fetch(`${API_BASE}/api/play/session/${state.sessionId}/complete`, { method: 'POST' });
    const data = await res.json();
    if (!res.ok) {
...
async function compareParticipant() {
    ...
    const res = await fetch(`${API_BASE}/api/play/session/${encodeURIComponent(state.sessionId)}/compare-participant/${encodeURIComponent(participantId)}`, {
        cache: 'no-store'
    });
...
async function loadHistory() {
    ...
    const res = await fetch(`${API_BASE}/api/play/history?visitor_id=${encodeURIComponent(visitor)}`, { cache: 'no-store' });
    const data = await res.json();
...
async function exportGif() {
    ...
    const res = await fetch(`${API_BASE}/api/play/export/gif`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
